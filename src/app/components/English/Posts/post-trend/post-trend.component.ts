...
import { AdoptI } from 'src/app/models/AdoptInterfaces/adopt.interface';
import { AdoptService } from 'src/app/services/HttpServices/adopt.service';

@Component({
  selector: 'app-post-trend',
  templateUrl: './post-trend.component.html',
  styleUrls: ['./post-trend.component.scss']
})
export class PostTrendComponent implements OnInit {
  ...
  constructor(private http:HttpClient, public posts:PostService, private ads:AdsService, private usersChat:UsersService, private router:Router, public authService:AuthService, private sign:SignInService, private loadScripts:LoadscriptsService,  private adopts:AdoptService) {
