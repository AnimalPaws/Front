...
import { EntityService } from '../../../../services/HttpServices/entity.service';

@Component({
  selector: 'app-post-entities',
  templateUrl: './post-entities.component.html',
  styleUrls: ['./post-entities.component.scss']
})
export class PostEntitiesComponent implements OnInit {
  ...
  constructor(private http:HttpClient, public posts:PostService, private ads:AdsService, private usersChat:UsersService, private router:Router, public authService:AuthService, private sign:SignInService, private loadScripts:LoadscriptsService, private entities:EntityService) {
  ...
  ngOnInit(): void {
    ...
    this.entities.getPost().subscribe(res =>{
      this.entity = res;
    })
  }
  editPost(id:any){
